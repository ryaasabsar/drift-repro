...
def main():
    ...
    compare.add_argument("--allow-confounded", action="store_true", help="Label and allow changed setup controls and safety-judge runtimes with a matching judge protocol")
    ...
    many.add_argument('--allow-confounded', action='store_true', help='Label and allow changed setup controls and safety-judge runtimes with a matching judge protocol')
