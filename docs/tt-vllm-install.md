...
It also installs TTNN 0.77.0, the matching TT-Metal source release, CPU PyTorch
...
The installer requires Linux x86_64 with glibc >=2.34, bash, git, curl and flock.
...
versions/dependencies, CPU PyTorch, TTNN imports and plugin discovery. A successful
